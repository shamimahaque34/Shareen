                        ...
                        @foreach($blogs as $blog)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('blog.status', ['id' => $blog->id])}}" class="btn {{$blog->status == 1 ? 'btn-info' : 'btn-warning'}} btn-sm">
                                        <i class="{{$blog->status == 1 ? 'fa fa-arrow-up' : 'fa fa-arrow-down'}}"></i>
                                    </a>
                                    <a href="{{route('blog.edit', ['id' => $blog->id])}}" class="btn btn-success btn-sm" title="Edit Blog">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="{{route('blog.delete', ['id' => $blog->id])}}" onclick="return confirm('Delete It?')" class="btn btn-danger btn-sm" title="Delete Blog">
