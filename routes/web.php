...
use App\Http\Controllers\ShareenController;
...
Route::get('/', [ShareenController::class,'index'])->name('home');
Route::get('/blog-category/{id}',[ShareenController::class,'category'])->name('blog-category');
Route::get('/blog-detail/{id}',[ShareenController::class,'detail'])->name('blog-detail');
Route::get('/contact', [ShareenController::class,'contact'])->name('contact');
Route::post('/contact-submit', [ShareenController::class,'contactSubmit'])->name('contact-submit');
